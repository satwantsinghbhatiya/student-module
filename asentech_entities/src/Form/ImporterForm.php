...
namespace Drupal\asentech_entities\Form;
...
use Drupal\asentech_entities\ParserInterface;
use Drupal\asentech_entities\Plugin\ImporterManager;
...
class ImporterForm extends FormBase {
   ...
   * The parser service.
   *
   * @var \Drupal\asentech_entities\Parser\ParserInterface
   */
  protected $parser;
   ...
   *
   * @var \Drupal\asentech_entities\Plugin\ImporterManager
   */
  protected $importer;
   ...
   *   The entity bundle info service.
   * @param \Drupal\asentech_entities\Parser\ParserInterface $parser
   *   The parser service.
   * @param \Drupal\Core\Render\RendererInterface $renderer
   *   The renderer service.
   * @param \Drupal\asentech_entities\Plugin\ImporterManager $importer
   *   The importer plugin manager service.
   */
  ...
  public static function create(ContainerInterface $container) {
    return new static(
      ...
      $container->get('asentech_entities.parser'),
      $container->get('renderer'),
      $container->get('asentech.plugin.manager.importer')
    );
  }
  ...
  public function buildForm(array $form, FormStateInterface $form_state) {
    ...
    $form['importer']['entity_type'] = [
      ...
      '#required' => TRUE,
      '#options' => ['student' => 'Student', 'score' => 'Score'],
      '#weight' => 0,
      '#ajax' => [
