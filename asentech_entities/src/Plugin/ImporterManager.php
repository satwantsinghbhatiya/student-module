...
class ImporterManager extends DefaultPluginManager {
  ...
  public function __construct(\Traversable $namespaces, CacheBackendInterface $cache_backend, ModuleHandlerInterface $module_handler) {
    parent::__construct('Plugin/Importer', $namespaces, $module_handler, 'Drupal\asentech_entities\Plugin\ImporterInterface', 'Drupal\asentech_entities\Annotation\Importer');
